...
#                        of executable (1/0)?
MODEL                = motor
MODULES              = main.c motor_TIM.c motor_USART.c rtGetInf.c rtGetNaN.c rt_nonfinite.c stm32xxxx_it.c
MODULES_OBJ          = main.obj motor_TIM.obj motor_USART.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj stm32xxxx_it.obj 
MAKEFILE             = motor.mk
...
# Additional includes
ADD_INCLUDES = \
 -IC:/Users/tuziz/Desktop/STMPRO~1/MATLAB~1  -IC:/Users/tuziz/Desktop/STMPRO~1/MATLAB~1/motor_stm32  -I$(MATLAB_ROOT)/extern/include  -I$(MATLAB_ROOT)/simulink/include  -I$(MATLAB_ROOT)/rtw/c/src  -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common  -I$(MATLAB_ROOT)/rtw/c/ert  -IC:/MATLAB/STM32-MAT/STM32/addSrc/inc 
